...
import tgaIO.TGAReader;

import static javax.microedition.khronos.opengles.GL10.*;

public final class TGAGLSurfaceView extends GLSurfaceView implements GLSurfaceView.Renderer {
	
	public TGAGLSurfaceView(final Context context) {
		super(context);
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		tgaTextures[0] = createTGATexture(gl, "Stile.tga");
		tgaTextures[1] = createTGATexture(gl, "Stile.tga");
		tgaTextures[2] = createTGATexture(gl, "Stile.tga");
	}
